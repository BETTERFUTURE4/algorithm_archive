...
4. 블랙잭 카드 생성하기
5. 실행하기
   1. 딜러와 플레이어에게 카드를 두 장씩 주기
   2. 처음 받은 두 장의 합이 21이면 승리시키기
   3. 딜러와 플레이어 중 핸드 가치(카드 가치의 합)가 더 높은 사람을 승리시키기 
   4. 핸드 가치가 21이 넘어간 사람 패배시키기
   5. 카드 더 주기
   6. 핸드 가치(카드 가치의 합)가 21이 넘어간 경우, ace에 1의 가치를 부여하기